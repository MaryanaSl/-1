...
2. Второй интересной задачей тут посчитала создание формы элемента Админиистратора Справочника "Сотрудники".
На форме, помимо реквизитов сотрудника, есть флажок «Вход разрешён» и поля ввода «Имя для входа» и «Пароль», отражающие свойства пользователя ИБ.
+ При записи сотрудника из этой формы при необходимости должно выполняться:
